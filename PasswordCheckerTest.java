...
public class PasswordCheckerTest {
	...
	public void setUp() throws Exception {
		String[] p = { "334455BB#", "george2ZZZ#", "4Sal#", "bertha22", "august30", "a2cDe", "ApplesxxxYYzz#", "aa11Bb", "pilotProject", "AAAbb@123" };
	...
	/**
	 * Test if the password is weak This test should throw a
	...
	public void testIsValidPasswordInvalidSequence() {
		try {
			assertEquals(false, PasswordCheckerUtility.isValidPassword("123@4aaAAA"));
	...
	/**
	 * Test the getInvalidPasswords method Check the results of the ArrayList of
